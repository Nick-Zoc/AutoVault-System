...
public class Login extends javax.swing.JFrame {
        ...
        private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loginButtonActionPerformed
                try {
                        ...
                        // if login successful, check role and open correct panel
                        if (loginSuccess) {
                                // get the user role
                                String userRole = controller.getUserRole(enteredUsername);

                                // check if user is admin or regular user
                                if (userRole.equals("Admin")) {
                                        // open admin panel for admin users
                                        ...
                                        // open user panel for regular users
                                        JOptionPane.showMessageDialog(this, "Login Successful! Welcome to AutoVault.",
                                                        "Success",
                                                        JOptionPane.INFORMATION_MESSAGE);
